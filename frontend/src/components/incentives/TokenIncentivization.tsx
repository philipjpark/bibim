        ...
        return (
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              Top performers in the BIBIM coefficient system. Higher coefficients = more BIBIM rewards.
            </Typography>
      ...
      case 1:
        return (
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              How the BIBIM coefficient system works:
            </Typography>
              ...
              <Grid item xs={12} md={6}>
                <Card>
                  <CardContent>
                    ...
                    <Alert severity="info">
                      Higher coefficients = More BIBIM rewards
                    </Alert>
                  </CardContent>
                </Card>
              </Grid>
      ...
      case 3:
        return (
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              Unlock special achievements for bonus BIBIM rewards and exclusive NFTs.
            </Typography>
      ...
      case 4:
        return (
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              Earn BIBIM tokens based on your coefficient ranking and achievements.
            </Typography>
                  ...
                  >
                    <CardContent sx={{ textAlign: 'center' }}>
                      ...
                      <Typography variant="h4" fontWeight="bold" sx={{ mb: 2 }}>
                        {reward.bibim.toLocaleString()} BIBIM
                      </Typography>
              ...
              <CardContent>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={12} md={4}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Bonus BIBIM for unlocking achievements
                    </Typography>
                  </Grid>
                  <Grid item xs={12} md={4}>
                    <Typography variant="body2" fontWeight="bold">
                  ...
                  <Grid item xs={12} md={4}>
                    <Typography variant="body2" fontWeight="bold">
                      Staking Rewards: Additional BIBIM
                    </Typography>
                    <Typography variant="body2" color="text.secondary">
      ...
      case 5:
        return (
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
              Track your progress and see how you're performing in the BIBIM coefficient system.
            </Typography>
