...
const Home: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Earn BIBIM tokens through strategic trading performance',
              ...
              >
                <Box sx={{ mb: 4 }}>
                  ...
                  <Typography 
                    ...
                    paragraph
                  >
                    Mix your perfect trading strategy like bibimbap. AI-powered insights, 
          ...
          >
            <Box sx={{ position: 'relative', zIndex: 1 }}>
              ...
              <Typography 
                ...
                sx={{ mb: 4, opacity: 0.9 }}
              >
                Join thousands of traders who trust BIBIM for their AI-powered strategies
              </Typography>
              <motion.div
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
