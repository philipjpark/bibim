...
`;
  ...
  private saveToLocalStorage() {
    try {
      localStorage.setItem('bibim_research_papers', JSON.stringify(this.papers));
      localStorage.setItem('bibim_research_corpus', JSON.stringify(this.corpus));
    } catch (error) {
  ...
  private loadFromLocalStorage() {
    try {
      const papersData = localStorage.getItem('bibim_research_papers');
      const corpusData = localStorage.getItem('bibim_research_corpus');
